        ...
        <div className="w-full  p-2 rounded-lg bg-background">
            ...
            <div className="flex items-center  justify-end space-x-2 py-4">
                <div className="flex-1 text-xs lg:text-sm text-muted-foreground">
                    ...
                    إلى {" "} {table.getFilteredSelectedRowModel().rows.length + 10} من إجمالي {table.getFilteredRowModel().rows.length} مدخلات
                </div>
    ...
    return (
        <div className=" flex gap-2 justify-center items-center">
            <Button
                variant="outline"
                size="sm"
                className=" size-8 p-1 text-slate-500 font-semibold"
            ...
            {table.getPageOptions().map((page: any) => (
                page >= 4 ? (
                    <Button
                        ...
                        variant='ghost'
                        size="sm"
                        className=" size-8 text-slate-500 font-semibold"
                    >
                        ...
                    </Button>
                ) :
