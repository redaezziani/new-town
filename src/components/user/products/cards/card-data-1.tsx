            ...
            <div className="flex w-full mt-4 gap-2 justify-between items-center">
                <div className="flex flex-col gap-2 justify-start items-start">
                    ...
                    >
                        ...
                        {" "}
                         {res 
                         && res.data.todayProducts.length > 0 
                         && res.data.todayProducts[0].product.currency || 'USD'
                         }
                    </h3>
                    <div
                    ...
                    >
                        <svg
                            className="stroke-current text-[#4ade80] dark:text-[#4ade80]"
                ...
                <div className=" w-[60%]">
                   {res && res.data.last7DaysProducts.length > 1 &&
                    <ProductsShart
                    //@ts-ignore
