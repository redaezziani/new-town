const InActiveBadge = () => {
  return (
    <span
    className=' w-fit flex justify-center items-center gap-2 rounded-full border text-red-600 border-red-600/50 bg-red-600/10  dark:border-red-600/50 dark:bg-red-600/10 dark:text-red-600-500 text-xs px-4 py-1'
  >
