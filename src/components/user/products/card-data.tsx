...
const ProductCardData = () => {
    return (
        <article
            className="rounded-lg hover:shadow-lg hover:border-slate-300/70 transition-all ease-in-out duration-300   gap-4 flex-col  flex justify-start items-start min-h-16  border border-slate-300/30  p-6 bg-background"
        >
            <h2
                className="text-2xl justify-start font-medium text-gray-900 dark:text-white flex gap-2"
            >
                Total Poructs
                <p
