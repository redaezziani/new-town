...
const SettingPage = async () => {
  ...
  return (
    <main
      className='w-full grid-cols-2 z-10 h-screen overflow-hidden grid md:grid-cols-3 gap-3'
    >
      ...
      <div className="w-full col-span-1 border-l p-2 border-dashed border-slate-300/60 flex justify-start items-start flex-col gap-4">
        ...
        <div className="flex flex-col  justify-start items-start">
          ...
          >
            this is the user informations page where you can update your informations
          </p>
        </div>
        <div className="flex flex-col  justify-start items-start">
        <img
