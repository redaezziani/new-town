  ...
  return (
    ...
    <path d="M8 12L16 12M8 12C8 11.2998 9.9943 9.99153 10.5 9.5M8 12C8 12.7002 9.9943 14.0085 10.5 14.5" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
      ...
      <div className="w-full max-w-7xl px-10 min-h-[30px] flex justify-start items-center relative">
        <img
          className="w-full h-full z-10 rounded-lg border border-slate-300/20 object-cover"
          src="/page.png" alt="" />
          <div className="w-full bg-primary/30 z-0  rounded-full blur-[300px] size-[30rem] absolute bottom-14 -left-36 ">
